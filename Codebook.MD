# Taken from README.txt of downloaded data set
...
# Taken from features_info.txt of original dataset
...
# COMPONENTS OF CODE
assumes working directory set as UCI HAR Dataset
##**********************************************************************************************************************************************************        
        ...
        ## label columnns using features.txt
...
##*********************************************************************************************************************************************************
        ...
        ## uses aggregate and order functions; then write.table to create text file.
